...
User_prompt;
_delay_ms(500);
Serial.print( eeprom_read_byte((uint8_t*)0x3FA));
_delay_ms(50);
Serial.print(eeprom_read_byte((uint8_t*)0x3FB));
_delay_ms(50);
...
EEPROM.put(0x3FA, char(User_correction_factor));
_delay_ms(15);
EEPROM.put(0x3FB, char(User_correction_factor));
_delay_ms(15);
...
Serial.print (200 + eeprom_read_byte((uint8_t*)0x3FA));
_delay_ms(10);
Serial.write("\r\n");
Serial.print(200 + eeprom_read_byte((uint8_t*)0x3FB));
_delay_ms(10);
SW_reset;
return 1;}
