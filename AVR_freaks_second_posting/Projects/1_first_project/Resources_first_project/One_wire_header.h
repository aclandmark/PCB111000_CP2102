...
//Mini_OS responds to  "Transaction type 'c' by clearing the display
...
//Initialses Timer 0 Output compare and counter values to zero, sets TO clock to 1MHz and starts it
...
//Increment Timer 0 Output compare register A and wait untill the value in the Timer 0 counter is the same 
