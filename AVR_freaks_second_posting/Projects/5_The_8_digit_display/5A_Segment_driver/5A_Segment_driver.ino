...
if (eeprom_read_byte ((uint8_t*)0x3FC) == 0xFF)eeprom_write_byte((uint8_t*)0x3F5, 0xFF);      //POR detected
//if(eeprom_read_byte ((uint8_t*)0x3FC) & 0x02) eeprom_write_byte((uint8_t*)0x3F5, 0xFF);      //press r at  p/r/t/D  prompt
...
case 'e': case 'E':
case 'f': case 'F':
case 'g': case 'G': One_wire_comms_any_segment(letter, digit_num); break;
...
eeprom_write_byte((uint8_t*)0x3F5, 0);    //eeprom_read_byte ((uint8_t*)0x3FC) & 0x02
  sei(); clear_display;
  SW_reset;
}
