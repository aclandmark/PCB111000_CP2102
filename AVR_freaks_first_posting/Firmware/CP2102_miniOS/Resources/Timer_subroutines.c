...
void Format_centi_secs_and_display(void){	
	...
	Hours =     centi_sec_counter/360000;
	Minutes =   (centi_sec_counter%360000)/6000;
	Seconds =   ((centi_sec_counter%360000)%6000)/100;
	centi_Secs = ((centi_sec_counter%360000)%6000)%100;	
