...
for(int m = 0; m <= 99; m++){                               //Measure time 100 times 
...
/************************************Print Previous User correction factor if avalibale*********************************************/
if(User_correction_factor_previous)
{
Serial.write("\r\nPrevious value of correction_factor was  ");
Serial.print(User_correction_factor_previous);
_delay_ms(5);}
